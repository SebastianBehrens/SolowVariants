...
Remark: Those parameters can be found via the command: \texttt{getRequiredParams("BS")}.
...
Remark: Those parameters can be found via the command: \texttt{getRequiredStartingValues("BS")}.
