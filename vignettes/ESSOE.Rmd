...
```
Note: The steady state of the variables FpW and Vpw as tested by `steadystate_checker` is only "reached" after around 4000 thousands periods. Keep that in mind regarding the TRUE or FALSE evaluation in the column "Economy in SS" in the output of `steadystate_checker`.
